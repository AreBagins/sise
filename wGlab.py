...
def solve_puzzle_dfs(initial_state, goal_state, width, height, move_order):
...
solution, visited_count, processed_count, max_depth, duration = solve_puzzle_dfs(initial_state, goal_state, width,
                                                                                 height, move_order)
