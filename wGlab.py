...
def start_bfs(option, input_data, width, height):
...
def start_dfs(option, input_data, width, height):
...
def start_astr(option, inputData, width, height):
...
def main():
    ...
    match strategy:
        case "bfs":
            sol, vc, pc, md, dr = start_bfs(option, inputData, width, height)
        case "dfs":
            sol, vc, pc, md, dr = start_dfs(option, inputData, width, height)
            if sol == 0: sol = None
        case "astr":
            sol, vc, pc, md, dr = start_astr(option, inputData, width, height)
    if sol is not None:
